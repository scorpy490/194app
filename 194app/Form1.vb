Public Class Form1
    ...
    Private Function t1(ByVal dt)
        ...
        cn.ConnectionString = "Provider=SQLOLEDB;Server=otk;Database=194;Trusted_Connection=yes;Integrated Security=SSPI;Persist Security Info=False"
        cn.open
    ...
    Private Sub CorrectDate() Handles RadioButton2.Click, RadioButton1.Click, Date1.CloseUp
        ...
        Else
            ...
            Date2.Value = Date2.Value.AddHours(7).AddMinutes(19).AddDays(1)
        End If
